...
public class AddCutomerAssertionValdi {
    ...
    public  void addCustomerTest() {
     ...
     /*   String expected = "[ "+custName+" ] Customer Details Added !";
        String actual = null;
        try {
            actual = driver.findElement(By.cssSelector("div.confirmation-box")).getText();
        }
        catch (Exception e)
        {
            actual="";
        ...
        Assert.assertEquals("incorrect  message or success message absent",expected,actual);
*/
        ...
        Assert.assertTrue("incorrect message/message absent",result);
